...
namespace SandcastleBuilder.Utils.BuildEngine
{
    partial class BuildProcess
    {
        ...
        private string OnFieldMatch(Match match)
        {
            ...
            switch(fieldName)
            {
                ...
                case "comments":
                    ...
                    // is specified and the feedback control is not shown.
                    if(!project.ShowFeedbackControl &&
                      project.FeedbackEMailAddress.Length != 0)
                ...
                case "help1xprojectfiles":
                    replaceWith = this.HelpProjectFileList(workingFolder +
                        @"Output\", HelpFileFormat.HtmlHelp1x);
                    break;

                case "help2xprojectfiles":
                    replaceWith = this.HelpProjectFileList(workingFolder +
                        @"Output\", HelpFileFormat.HtmlHelp2x);
                    break;
                ...
                case "syntaxfilters":
                    ...
                    if((project.SyntaxFilters & SyntaxFilters.VisualBasicUsage) != 0)
                        replaceWith += "<generator type=\"Microsoft.Ddue." +
                            "Tools.VisualBasicUsageSyntaxGenerator\" " +
                            "assembly=\"" + sandcastleFolder +
                            "ProductionTools\\SyntaxComponents.dll\" />\r\n";
                    ...
                    if((project.SyntaxFilters & SyntaxFilters.JScript) != 0)
                        replaceWith += "<generator type=\"Microsoft.Ddue." +
                            "Tools.JScriptDeclarationSyntaxGenerator\" " +
                            "assembly=\"" + sandcastleFolder +
                            "ProductionTools\\SyntaxComponents.dll\" />\r\n";

                    if((project.SyntaxFilters & SyntaxFilters.JavaScript) != 0)
                        replaceWith += "<generator type=\"SandcastleBuilder." +
                            "Components.JavaScriptDeclarationSyntaxGenerator\" " +
                            "assembly=\"" + shfbFolder +
                            "SandcastleBuilder.Components.dll\" />\r\n";

                    if((project.SyntaxFilters & SyntaxFilters.XamlUsage) != 0)
                        replaceWith += "<generator type=\"Microsoft.Ddue." +
                            "Tools.XamlUsageSyntaxGenerator\" " +
                            "assembly=\"" + sandcastleFolder +
                            "ProductionTools\\SyntaxComponents.dll\" >\r\n" +
                            "<filter files=\"" + sandcastleFolder +
                            "Presentation\\Shared\\configuration\\" +
                            "xamlSyntax.config\"/>\r\n</generator>";
                    break;
                ...
                case "syntaxfiltersdropdown":
                    ...
                    if((project.SyntaxFilters & SyntaxFilters.VisualBasicUsage) != 0)
                        replaceWith += "<language label=\"VisualBasicUsage\" " +
                            "name=\"VisualBasicUsage\" style=\"vb\" />\r\n";

                    if((project.SyntaxFilters & SyntaxFilters.CPlusPlus) != 0)
                        replaceWith += "<language label=\"ManagedCPlusPlus\" " +
                            "name=\"ManagedCPlusPlus\" style=\"cpp\" />\r\n";
                    ...
                    if((project.SyntaxFilters & SyntaxFilters.JScript) != 0)
                        replaceWith += "<language label=\"JScript\" " +
                            "name=\"JScript\" style=\"cs\" />\r\n";

                    if((project.SyntaxFilters & SyntaxFilters.JavaScript) != 0)
                        replaceWith += "<language label=\"JavaScript\" " +
                            "name=\"JavaScript\" style=\"cs\" />\r\n";

                    if((project.SyntaxFilters & SyntaxFilters.XamlUsage) != 0)
                        replaceWith += "<language label=\"XAML\" " +
                            "name=\"XAML\" style=\"cs\" />\r\n";
                    break;
                ...
                case "feedbackvisibility":
                    if(project.ShowFeedbackControl)
                        replaceWith = "style=\"display: inline;\"";
                    else
                        replaceWith = "style=\"display: none;\"";
                    break;
          ...
          CultureInfo language, string version)
        {
            ...
            {
                // 2.0, 3.0, and 3.5 are cummulative
                folder = Environment.ExpandEnvironmentVariables(
        ...
        private void MergeComponentConfigurations()
        {
            ...
            help2Id = "HTML Help 2 Attributes";

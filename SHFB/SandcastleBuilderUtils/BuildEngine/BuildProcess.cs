...
namespace SandcastleBuilder.Utils.BuildEngine
{
    ...
    public partial class BuildProcess
    {
        ...
        private Collection<string> help1Files, help2Files, websiteFiles;
        ...
        /// </summary>
        /// <remarks>If the Help 1 format was not built, this returns an
        ...
        /// </summary>
        /// <remarks>If the Help 2 format was not built, this returns an
        /// empty collection.</remarks>
        ...
        public void Build()
        {
            ...
            try
            {
                ...
                // For HTML Help 2.x, the HTML Help Name cannot contain spaces
                if((project.HelpFileFormat & HelpFileFormat.HtmlHelp2x) != 0 &&
                  project.HtmlHelpName.IndexOf(' ') != -1)
                    throw new BuilderException("BE0031", "For HTML Help 2 " +
                ...
                if((project.HelpFileFormat & (HelpFileFormat.HtmlHelp1x |
                  HelpFileFormat.Website)) != 0)
                {
                    this.ReportProgress(BuildStep.ExtractingHtmlInfo,
                        "Extracting HTML info for Help 1.x and/or website...");
                ...
                if((project.HelpFileFormat & HelpFileFormat.HtmlHelp1x) != 0)
                {
                    ...
                    this.ReportProgress(
                        ...
                        "Generating HTML Help 1.x table of contents file...");

                    currentFormat = HelpFileFormat.HtmlHelp1x;
                    ...
                    this.UpdateTableOfContents(HelpFileFormat.HtmlHelp1x);
                ...
                if((project.HelpFileFormat & HelpFileFormat.HtmlHelp2x) != 0)
                {
                    ...
                    this.ReportProgress(
                        BuildStep.GenerateHelpFormatTableOfContents,
                        "Generating Help 2.x table of contents file...");

                    currentFormat = HelpFileFormat.HtmlHelp2x;
                    ...
                    this.UpdateTableOfContents(HelpFileFormat.HtmlHelp2x);
                ...
                if((project.HelpFileFormat & HelpFileFormat.HtmlHelp1x) != 0)
                {
                    ...
                    if(hhcFolder.Length == 0 || !Directory.Exists(hhcFolder))
                        throw new BuilderException("BE0037", "Could not find " +
                            "the path the the HTML 1.x help compiler. See " +
                            "error topic in help file for details.\r\n");
                    ...
                    if(hxcompFolder.Length == 0 ||
                      !Directory.Exists(hxcompFolder))
                        throw new BuilderException("BE0038", "Could not find " +
                            "the path to the HTML 2.x help compiler.  See " +
                            "error topic in help file for details.\r\n");

...
namespace SandcastleBuilder.PlugIns
{
    ...
    public class DeploymentPlugIn : IPlugIn
    {
        ...
        private DeploymentLocation deployHelp1, deployHelp2, deployWebsite;
          ...
          XPathNavigator configuration)
        {
            ...
            if(deployHelp1.Location == null &&
              (builder.CurrentProject.HelpFileFormat & HelpFileFormat.HtmlHelp1x) != 0)
                builder.ReportWarning("ODP0003", "HtmlHelp1x will be " +
                    "generated but not deployed due to missing deployment " +
                    "location information");

            if(deployHelp2.Location == null &&
              (builder.CurrentProject.HelpFileFormat & HelpFileFormat.HtmlHelp2x) != 0)
                builder.ReportWarning("ODP0003", "HtmlHelp2x will be " +
                    "generated but not deployed due to missing deployment " +
                    "location information");
        ...
        public void Execute(ExecutionContext context)
        {
            ...
            if(builder.CurrentFormat == HelpFileFormat.HtmlHelp1x)
            {
                builder.ReportProgress("Deploying HTML Help 1.x file");
                this.DeployOutput(builder.Help1Files, deployHelp1);
            }

            if(builder.CurrentFormat == HelpFileFormat.HtmlHelp2x)
            {
                builder.ReportProgress("Deploying HTML Help 2.x files");

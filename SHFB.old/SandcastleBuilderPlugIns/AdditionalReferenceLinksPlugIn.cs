        ...
        private bool BuildProject(SandcastleProject project, string workingPath)
        {
            ...
            try
            {
                ...
                project.SandcastlePath = new FolderPath(
                    builder.SandcastleFolder, true, null);
                project.HtmlHelp1xCompilerPath = new FolderPath(
                    builder.Help1CompilerFolder, true, null);
                project.HtmlHelp2xCompilerPath = new FolderPath(
                    builder.Help2CompilerFolder, true, null);
                project.WorkingPath = new FolderPath(workingPath, true, null);
                project.OutputPath = new FolderPath(workingPath +
                    @"..\PartialBuildLog\", true, null);

                    ...
                    while(!sr.EndOfStream)
                    {
                        ...
                        switch(lastProperty)
                        {
                            ...
                            case "outputtype":
                                if(value.IndexOf("website",
                                  StringComparison.OrdinalIgnoreCase) != -1)
                                    project.HelpFileFormat = HelpFileFormat.Help1xAndWebsite;
                                break;
                            ...
                            case "cssyntaxdeclaration":
                                if(String.Compare(value, "false",
                                  StringComparison.OrdinalIgnoreCase) == 0)
                                    project.SyntaxFilters &= ~SyntaxFilters.CSharp;
                                break;

                            case "vbsyntaxdeclaration":
                                if(String.Compare(value, "false",
                                  StringComparison.OrdinalIgnoreCase) == 0)
                                    project.SyntaxFilters &= ~SyntaxFilters.VisualBasic;
                                break;

                            case "cppsyntaxdeclaration":
                                if(String.Compare(value, "false",
                                  StringComparison.OrdinalIgnoreCase) == 0)
                                    project.SyntaxFilters &= ~SyntaxFilters.CPlusPlus;
                                break;

                            case "javascriptsyntaxdeclaration":
                                if(String.Compare(value, "true",
                                  StringComparison.OrdinalIgnoreCase) == 0)
                                    project.SyntaxFilters |= SyntaxFilters.JavaScript;
                                break;

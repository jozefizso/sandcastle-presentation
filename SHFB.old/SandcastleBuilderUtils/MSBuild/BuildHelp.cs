    ...
    public class BuildHelp : Task
    {
        ...
        public ITaskItem[] Help1Files
        {
            get
            {
                ...
                {
                    files = new ITaskItem[buildProcess.Help1Files.Count];

                    foreach(string file in buildProcess.Help1Files)
                    {
                        files[idx] = new TaskItem(file);
                        idx++;
                    }
                }
                else
        ...
        public ITaskItem[] Help2Files
        {
            get
            {
                ...
                if(buildProcess != null && lastBuildStep == BuildStep.Completed)
                {
                    files = new ITaskItem[buildProcess.Help2Files.Count];
        ...
        public ITaskItem[] WebsiteFiles
        {
            get
            {
                ...
                if(buildProcess != null && lastBuildStep == BuildStep.Completed)
                {
                    files = new ITaskItem[buildProcess.WebsiteFiles.Count];
        ...
        public ITaskItem[] AllHelpFiles
        {
            get
            {
                ITaskItem[] help1 = this.Help1Files,
                    help2 = this.Help2Files, website = this.WebsiteFiles;

                ITaskItem[] all = new ITaskItem[help1.Length + help2.Length +
                    website.Length];

                help1.CopyTo(all, 0);
                help2.CopyTo(all, help1.Length);
                website.CopyTo(all, help1.Length + help2.Length);
          ...
          BuildProgressEventArgs e)
        {
            ...
            if(e.HasCompleted)
            {
                ...
                if(e.BuildStep == BuildStep.Completed)
                {
                    ...
                    if(sandcastleProject.HelpFileFormat ==

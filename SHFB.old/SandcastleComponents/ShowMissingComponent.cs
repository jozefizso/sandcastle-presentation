...
namespace SandcastleBuilder.Components
{
    ...
    public class ShowMissingComponent : BuildComponent
    {
        ...
        private string autoDocCtorMsg, autoDocStaticCtorMsg, missingTagMsg,
          ...
          XPathNavigator configuration) : base(assembler, configuration)
        {
            ...
            autoDocConstructors = showMissingParams = showMissingTypeParams =
                showMissingReturns = showMissingSummaries =
            ...
            isEnabled = (autoDocConstructors || showMissingParams ||
                showMissingTypeParams || showMissingRemarks ||
                showMissingReturns || showMissingSummaries ||
                showMissingValues || showMissingNamespaces ||

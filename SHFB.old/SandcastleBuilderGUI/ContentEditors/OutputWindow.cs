...
namespace SandcastleBuilder.Gui.ContentEditors
{
    ...
    public partial class OutputWindow : BaseContentEditor
    {
        ...
        public static string TransformLogFile(string logFile)
        {
          ...
          EventArgs e)
        {
            ...
            {
                wbLogContent.Visible = tsbPrint.Visible = tslLogFile.Visible =
                    false;
            ...
            wbLogContent.Visible = tsbPrint.Visible = tslLogFile.Visible = true;
        ...
        {
            tcbViewOutput.Enabled = tsbPrint.Enabled = !isBuilding;
        }
        #endregion
    }
}
